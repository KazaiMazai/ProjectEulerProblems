...
std::vector<int> evaluate_dice_outcomes_histogram(const int attempts_count, const int dice_sides_count) {
...
double DiceGameProblem::solveProblem() const {
    ...
    std::vector<int> first_dice_outcomes_hist = evaluate_dice_outcomes_histogram(attempts_with_first_dice_count,
    ...
    std::vector<int> second_dice_outcomes_hist = evaluate_dice_outcomes_histogram(attempts_with_second_dice_count,
